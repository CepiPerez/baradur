...
class FieldFactoryAbstract
{
    ...
    public function validate($value)
    {
        ...
        if (strpos($value, '/') !== false) {
            ...
            return $this->validate($range) && is_numeric($step); //  filter_var($step, FILTER_VALIDATE_INT);
        }
        ...
        //dump("FILTER:", $value, is_numeric($value), in_array($value, $this->fullRange, true), $this->fullRange);
