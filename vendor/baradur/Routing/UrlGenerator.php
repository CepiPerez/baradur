...
class UrlGenerator
{
     ...
     * @return void
     */
    public function __construct($routes, $request, $assetRoot = null)
    {
        $this->routes = $routes;
    ...
    {
        return $this->getSession()? $this->getSession()->previousUrl() : null;
    }
     ...
     * @return string
     */
    public function query($path, $query = array(), $extra = array(), $secure = null)
    {
    ...
    public function formatScheme($secure = null)
    {
        ...
        if (is_null($this->cachedScheme)) {
            $this->cachedScheme = $this->forceScheme ? $this->forceScheme : $this->request->getScheme().'://';
        }
     ...
     */
    public function signedRoute($name, $parameters = array(), $expiration = null, $absolute = true)
    {
        ...
        if ($expiration) {
            $parameters = $parameters + array('expires' => $this->availableAt($expiration));
        }
        ...
        return $this->route($name, $parameters + array(
     ...
     * @return string
     */
    public function temporarySignedRoute($name, $expiration, $parameters = array(), $absolute = true)
    {
     ...
     * @return bool
     */
    public function hasValidSignature($request, $absolute = true, array $ignoreQuery = array())
    {
     ...
     * @return bool
     */
    public function hasValidRelativeSignature($request, array $ignoreQuery = array())
    {
     ...
     * @return bool
     */
    public function hasCorrectSignature($request, $absolute = true, array $ignoreQuery = array())
    {
    ...
    {
        $parameters = collect(Arr::wrap($parameters))->all();
    ...
    public function formatRoot($scheme, $root = null)
    {
        if (is_null($root)) {
            if (is_null($this->cachedRoot)) {
                $this->cachedRoot = $this->forcedRoot ? $this->forcedRoot : $this->request->root();
            }
